        ...
        <div class="lg:w-3/5 mx-auto flex flex-wrap">
          ...
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 class="text-sm title-font text-gray-500 tracking-widest uppercase inline-block mr-2"
              v-for="category in product.categories" v-text="category.name"></h2>
            ...
            <OptionToggle :values="colors" :allValues="allColors" :selected="options.color" :updateState="options.size !== null" @change="colorChanged">
            </OptionToggle>
            <h1 class="mt-5">
              Sizes
            </h1>
